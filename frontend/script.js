...
window.onload = function() {
    ...
    setTimeout(() => {
        ...
        setTimeout(() => {
            addMessageWithTypewriterEffect("bot", "Hello! I'm A.L.A.B, your MSU-IIT virtual assistant. How can I help you today? (Please note that my knowledge is limited as I am initially trained with FAQs.)");
        }, 800);
    }, 300);
};
...
function sendMessageToServer(message) {
    const url = 'https://alabchatmw.msuiit.edu.ph/webhooks/rest/webhook';
